			...
			<div id="board">
				<form class="board-form" method="post"
					...
					<input type="hidden" name="a" value="modify"> <input
						id="id" name="id" type="hidden" value=${vo.id }> <input
						id="p" name="p" type="hidden" value=${param.p }>
					<table class="tbl-ex">
						<tr>
							<th colspan="2">글수정</th>
						</tr>
					...
					<div class="bottom">
						<a
							href="${pageContext.servletContext.contextPath }/board?a=view&id=${vo.id }&p=${param.p }">취소</a>
